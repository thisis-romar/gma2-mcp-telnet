...
Tests all documented CD forms from the grandMA2 v3.9 manual:
  ...
  cd "Element name"             - Navigate by name
  cd [Object-type] [Object-ID] - Navigate to specific object
"""
...
class TestChangeDestCommands:
    ...
    def test_keyword_object_id(self):
        """Using keyword argument for object_id."""
